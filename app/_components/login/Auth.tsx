  ...
  return (
    ...
    >
      ...
      <form className="mt-5 flex flex-col gap-2" onSubmit={handleLogin}>
        ...
        <input
          className={clsx(
            "mb-5 h-10 w-full rounded border-[1px] border-input pl-4 text-[13px] duration-300 focus:border-primary focus:outline-none focus:ring-0 lg:cursor-pointer lg:hover:border-primary",
            darkMode
        ...
        <button
          className={
            "block h-12 w-full rounded-3xl border-0 bg-primary duration-300 focus:border-[1px] focus:border-primary-hover focus:outline-none focus:ring-0 lg:hover:bg-primary-hover"
          }
          disabled={loading}
        >
